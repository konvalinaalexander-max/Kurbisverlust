-- sicht: v_koeff_nebenkanal
-- Der Nebenkanal-Koeffizient je Sorte mit Bereich, Zahl der Messungen und Bezugsgrösse. Anteil der Masse, der weder verkaufsfähig noch Verlust ist, sondern in einen anderen Kanal geht.
 ...
 SELECT sk.sorte,
   ...
   FROM sorte_kaliber sk
     LEFT JOIN LATERAL ( SELECT g.art,
          ...
          WHERE g.art = 'nebenkanal'::text AND NOT g.sorte IS DISTINCT FROM sk.sorte) k ON true;
